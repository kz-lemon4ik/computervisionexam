...
def main():
    parser = argparse.ArgumentParser(description='Train YOLOv5 for license plate detection')
    parser.add_argument('--data', default='data/yolo/dataset.yaml', help='Dataset config file')
