...
def calculate_metrics(predictions, targets):
    ...
    pred_flat = predictions.flatten() if hasattr(predictions, 'flatten') else np.array(predictions).flatten()
    target_flat = targets.flatten() if hasattr(targets, 'flatten') else np.array(targets).flatten()
