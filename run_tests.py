...
def main():
    ...
    if not success or len(sys.argv) == 1:
        ...
        print(f"  python run_tests.py test_models     # Run specific test module")
        print(f"  python run_tests.py test_pipeline   # Run pipeline tests")
        print(f"  python run_tests.py test_data_loader # Run data loader tests")
