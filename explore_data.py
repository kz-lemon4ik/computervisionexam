...
def explore_ccpd_dataset():
    ...
    if annotations:
        ...
        print(
            f"Most common characters: {sorted(char_counts.items(), key=lambda x: x[1], reverse=True)[:10]}"
        )
    ...
    print("\nDataset structure:")
    print(
        "  Format: Area-AgentType-TimeOfDay&Province_coordinates-bbox_coordinates-landmarks-characters-brightness-blur.jpg"
    )
